            ...
            <div class="row">
                <div class="col-sm-6">
                    <h2>Aplikasi Pembayaran SPP</h2>
                     <p class="lead">Aplikasi ini dibuat untuk memenuhi Uji Kompetensi Keahlian paket 1 mengenai aplikasi pembayaran spp.</p> 
                </div>
        ...
        <div class="container mt-5">
            <div class="row text-center">
                <div class="col-md">
                    ...
                    <p class="lead">Copyright &copy; <?= date('Y') ?>, Design & Developer By 12 RPL 1</p>
                </div>
            </div>
        </div>
    </footer> 
